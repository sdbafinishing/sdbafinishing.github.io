      ...
      <div class="card" style="padding:24px;">
        ...
        <div id="g-photo" class="gs">
          ...
          <ul>
            ...
            <li><strong>${ic('image')} Quick View button</strong> on the race page resolves in this order: (1) show the saved image instantly; (2) if none, generate on the fly from the Joyi files with a spinner, save, then show; (3) if no files found, open the drag-drop picker. The lightweight viewer has Download + Close. (Planned: also publish a small JPEG so the same button works on the online/iPad viewer.)</li>
          </ul>
